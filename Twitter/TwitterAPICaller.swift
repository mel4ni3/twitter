...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "fCxxq97P5Zg4zVeqeyOM93r2S", consumerSecret: "Dj5ALeJjrNkl6N8zp5yAdetwSnIpxAsW7mmgfLZfLbLLvwuLUT")
    var loginSuccess: (() -> ())?
